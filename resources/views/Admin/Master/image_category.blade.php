            ...
            <div id="add_category_modal" class="modal fade" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="{{ url('admin/add_image_category') }}" class="ajax-form-submit" id="cform"
    ...
    <script type="text/javascript">
        ...
        $(function() {
            var table = $('.data-table').DataTable({
                ...
                ajax: "{{ route('admin/image_category_list') }}",
                columns: [{
                        data: 'catId',
                        name: 'catId'
                    },
        ...
        function editable_remove(data_delete) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{ url('admin/delete_image_category') }}",
                        type: 'post',
                        data: {
                            _token: CSRF_TOKEN,
                            id: id
        ...
        function edit_image_category(edit_category) {
            var id = $(edit_category).data('val');
            $.ajax({
                type: 'POST',
                url: "{{ url('admin/get_image_category_data') }}",
                data: {
                    id: id
                },
                success: function(response) {
