            ...
            <div class="card custom-card">
                <a href="status_image_category">
                    <div class="card-body dash1">
                        ...
                        <div>
                            {{-- <h3 class="dash-25 text-primary">{{ $status_image_category }}</h3> --}}
                        </div>
                    </div>
                </a>
            </div>
            ...
            <div class="card custom-card">
                <a href="status_image">
                    <div class="card-body dash1">
                        ...
                        <div>
                            {{-- <h3 class="dash-25 text-secondary">{{ $status_images }}</h3> --}}
                        </div>
                    </div>
                </a>
            </div>
            ...
            <div class="card custom-card">
                <a href="status_video_category">
                    <div class="card-body dash1">
                        ...
                        <div>
                            {{-- <h3 class="dash-25 text-success">{{ $status_video_category }}</h3> --}}
                        </div>
                    </div>
                </a>
            </div>
            ...
            <div class="card custom-card">
                <a href="status_video">
                    <div class="card-body dash1">
                        ...
                        <div>
                            {{-- <h3 class="dash-25 text-success">{{ $status_videos }}</h3> --}}
                        </div>
                    </div>
                </a>
            </div>
            ...
            <div class="card custom-card">
                <a href="api_call">
                    <div class="card-body dash1">
                        ...
                        <div>
                            {{-- <h3 class="dash-25 text-info">{{ $api_calls }}</h3> --}}
                        </div>
                    </div>
                </a>
            </div>
