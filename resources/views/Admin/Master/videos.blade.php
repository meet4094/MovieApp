        ...
        <div id="add_Videos_modal" class="modal fade" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ url('admin/add_videos') }}" class="ajax-form-submit" id="cform" method="post"
...
@section('scripts')
    <script type="text/javascript">
        ...
        $(".select2").select2({
            ...
            width: "100%",
            ajax: {
                url: "{{ url('admin/get_video_Category') }}",
                type: "post",
                allowClear: true,
                dataType: 'json',
                delay: 250,
