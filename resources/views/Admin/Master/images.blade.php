        ...
        <div id="add_Images_modal" class="modal fade" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ url('admin/add_images') }}" class="ajax-form-submit" id="cform" method="post"
...
@section('scripts')
    <script type="text/javascript">
        ...
        $(".select2").select2({
            ...
            width: "100%",
            ajax: {
                url: "{{ url('admin/get_image_Category') }}",
                type: "post",
                allowClear: true,
                dataType: 'json',
                delay: 250,
        ...
        function edit_image(edit_item) {
            var id = $(edit_item).data('val');
            var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
            $.ajax({
                type: 'POST',
                url: "{{ url('admin/get_images_data') }}",
                data: {
                    _token: CSRF_TOKEN,
                    id: id
                },
